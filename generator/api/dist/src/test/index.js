        ...
        function setNewStateRecursively(current, keys, newValue) {
            ...
            if (restKeys.length === 0) {
                if (Array.isArray(newValue)) {
                    ...
                    return Object.assign(Object.assign({}, current), { [firstKey]: newValue });
                }
                else if (typeof newValue === 'object' && newValue !== null) {
                    // Merge with existing object
                    return Object.assign(Object.assign({}, current), { [firstKey]: Object.assign(Object.assign({}, current[firstKey]), newValue) });
                }
                else {
