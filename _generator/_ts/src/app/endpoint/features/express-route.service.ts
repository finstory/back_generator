...
import { BasicRouteDto, BasicRouteDtoV2, RouteEditionDto } from "@/_common/db/dto/route.dto";
...
class ExpressRouteService extends Injectable {
    ...
    createRoute = async (moduleName: string, { endpointName, requestType, controllerName }: BasicRouteDtoV2) => {
    ...
    editRoute = async (moduleName: string, route: BasicRouteDtoV2, newRoute: RouteEditionDto) => {
